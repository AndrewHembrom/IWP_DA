...
const QUESTIONS = [{
    ...
    views: "100M",
    timestamp: "1 day ago",
    description: "Whatever Barca is cooking is working tf out man Imagine that files on your desktop didn’t have names. Instead, you’d refer to them by their order — the first file, the second file, and so on. You could get used to it, but once you delete a file, it would get confusing. The second file would become the first file, the third file would be the second file, and so on."
},{
